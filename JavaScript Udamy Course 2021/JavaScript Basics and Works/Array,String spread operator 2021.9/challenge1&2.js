...
console.log(
  `${gk} is a Goal Keeper, and ${fieldPlayers} are field players in a ${game.team1}'s team.`
);
...
const printGoals = function (...players) {
  console.log(
    `${players} is players that have created ${players.length} goals.`
  );
};
printGoals('Davies', 'Muller', 'Kimmich');
printGoals(...game.scored);

// 7. (check condition without if/else/?)
