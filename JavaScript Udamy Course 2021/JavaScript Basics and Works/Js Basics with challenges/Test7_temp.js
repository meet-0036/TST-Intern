...
// Something on debugging process
...
const measureKelvin = function () {
  const measurement = {
    ...
    // C) FIX
    // value: prompt('Degrees celsius:'), // problem : prompt take in string(BUG)
    // value: Number(prompt('Degrees celsius:')), // resolve by converting in number

    value: 10,
  };

  // B) FIND   (sources and put red dot and play/pause execution)
